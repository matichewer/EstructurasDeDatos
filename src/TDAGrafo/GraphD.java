...
public interface GraphD<V,E> {
	...
	/**
	 * Devuelve una coleccion iterable de arcos adyacentes a un vertice v.
	 * @param v Un vertice
	 * @return Una coleccion iterable de arcos adyacentes a un vertice v.
	 * @throws InvalidVertexException si el vertice es invalido.
	 */
	...
	/**
	 * Inserta un nuevo arco con rotulo e, desde un vertice v a un vertice w.
	 * @param v Un vertice
	 * @param w Un vertice
	 * @param e rotulo del nuevo arco.
	 * @return Un nuevo arco insertado desde un vertice V a un vertice W.
	 * @throws InvalidVertexException si uno de los vertices es invalido.
	 */
