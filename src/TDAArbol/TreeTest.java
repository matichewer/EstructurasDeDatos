...
public class TreeTest {
	...
	public void addBefore() {
		...
		try {
			...
			hijosH1 = new ListaDE_CC_EPyU<Integer>();
			hijosH1.addFirst(4);
			hijosH1.addFirst(5);
			hjsH1 = new ListaDE_CC_EPyU<Integer>();
	...
	public void addAfter() {
		...
		try {
			...
			chequearPadre(T.root());
			// caso de prueba para los hijos de root
			PositionList<Integer> hijosRoot = new ListaDE_CC_EPyU<Integer>();
			hijosRoot.addFirst(2);
			hijosRoot.addFirst(7);
			hijosRoot.addFirst(3);
			hijosRoot.addFirst(6);
			hijosRoot.addFirst(9);
			PositionList<Integer> hijos = new ListaDE_CC_EPyU<Integer>();
			for (Position<Integer> n : T.children(T.root())) {
	...
	public void removeInternal() {
		...
		lista = new ListaDE_CC_EPyU<Integer>();
		for (i = 1; i <= 12; i++)
			lista.addLast(i);
	...
	public void remove() {
		...
		T = getTree();
		cargarArbol2(T);
		lista = new ListaDE_CC_EPyU<Position<Integer>>();
		try {
